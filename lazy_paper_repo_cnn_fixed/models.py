    ...
    def _make_layers(self, cfg,k):
        ...
        for x in cfg:
            if x == 'M':
                ...
                # change: changed kernel_size to 2 because kernel_size=3 produces Output size is too small Runtime Error
                layers += [nn.Conv2d(in_channels, x*k, kernel_size=2, padding=1),
                          # nn.BatchNorm2d(x),
