...
def plot_loss_from_file_convnets(path, depth=7):
    ...
    train_loss_plt.plot(widths, train_losses[:,-1], marker='o', markersize=mrkr_size, label='Final Train Loss')
    train_loss_plt.plot(widths, optimal_early_train_losses, marker='o', markersize=mrkr_size, label='Optimal Early Stopping Train Loss')
    train_loss_plt.set_ylabel('Train Loss', fontsize=16)
    
    # plot final and optimal early stopping test loss
    test_loss_plt.plot(widths, test_losses[:,-1], marker='o', markersize=mrkr_size, label='Final Test Loss')
    test_loss_plt.plot(widths, optimal_early_test_losses, marker='o', markersize=mrkr_size, label='Optimal Early Stopping Test Loss')
...
def plot_loss_vs_epoch_from_file_convnets(
    ...
    if isinstance(save_fig, str):
        ...
        save_fig = save_fig if save_fig.endswith('.png') or save_fig.endswith('.jpg') else save_fig + '.png'
